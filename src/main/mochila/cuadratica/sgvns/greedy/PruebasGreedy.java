...
//        instanciasAlgoritmo.add(new GrupoInstancias("mochilaCuadratica/grupo1/", "jeu_300_50_%d.txt", 1, 10));
        double porcentaje = 0;
        ...
        for (GrupoInstancias ginstancia : gruposInstancias) {
            ...
            for (Instancia instancia : instancias) {
                ...
                FuncionSGVNS funcionSGVNS = new FuncionSGVNS(matrizBeneficios, capacidad, vectorPesos, maxGlobal);
                SGVNS aSGVNS = new SGVNS(funcionSGVNS);

                // generar individuo
                IndividuoVNS mochila = new IndividuoVNS(funcionSGVNS);
                int rcl = 5;
                // lista indices
                long tiempo_inicial = System.currentTimeMillis();
                IndividuoVNS individuo = (new Greedy(rcl)).ejecutarGreedy(mochila);
