 ...
 */
package main.mochila.cuadratica.sgvns.greedy;
...
public class Greedy {
    ...
    public IndividuoVNS ejecutarGreedy(IndividuoVNS individuo) {
...
//            individuo = funcionGreedyAdaptada(individuo);
     ...
     * @return
     */
    protected List<Item> crearLRC(IndividuoVNS individuo, int rcl) {
    ...
    protected List<Item> crearLRC2(IndividuoVNS individuo, int rcl) {
        List<Item> listItemNoSeleccionados = obtenerItemsNoSeleccionadosViables(individuo);
        List<Item> LRC = new ArrayList();
        int tamL = listItemNoSeleccionados.size();
        int tamanio = Math.min(rcl, tamL);
    ...
    protected List<Item> crearLRC3(IndividuoVNS individuo, int rcl) {
        List<Item> listItemNoSeleccionados = obtenerItemsNoSeleccionadosViables(individuo);
     ...
     * @return
     */
    private List<Item> obtenerItemsNoSeleccionadosViables(IndividuoVNS individuo) {
        List<Integer> noSeleccionadosRS = individuo.elementosNoSeleccionados();
        FuncionSGVNS funcion = (FuncionSGVNS) individuo.getFuncion();
