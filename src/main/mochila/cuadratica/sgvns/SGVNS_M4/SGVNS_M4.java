 ...
 */
package main.mochila.cuadratica.sgvns.SGVNS_M4;
 ...
 * @author Juan Diaz PC
 */
public class SGVNS_M4 extends SGVNS {

    public SGVNS_M4(FuncionSGVNS funcion, int maxIteraciones) {
        super(funcion, maxIteraciones);
        this.setNombre("SGVNS_M4");
    }
