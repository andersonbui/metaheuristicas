 ...
 * @author debian
 */
public class MochilaMultidOrdenXDensidadBeneficioM2 extends MochilaMultidimensional_LimitRellenoM {
     ...
     *
     */
    public MochilaMultidOrdenXDensidadBeneficioM2(double[][] VectorRestricciones, double[] beneficios, double[] capacidades) {
