 ...
 * @author debian
 */
public class MochilaMultidOrdenAvanzado extends MochilaMultidOrdenXDensidadBeneficio {
     ...
     *
     */
    public MochilaMultidOrdenAvanzado(double[][] VectorRestricciones, double[] beneficios, double[] capacidades) {
