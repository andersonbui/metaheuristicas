 ...
 * @author debian
 */
public class MochilaMultidimensional_LimitRelleno extends MochilaMultidimensionalOriginal {
     ...
     * @param capacidades
     */
    public MochilaMultidimensional_LimitRelleno(double[][] VectorRestricciones, double[] beneficios, double[] capacidades) {
